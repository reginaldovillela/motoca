...
/// <param name="DriversLicenseLevel">Categoria da carteira de motorista</param>
...
public record DriversLicense(
    ...
    [property:JsonPropertyName("tipo"), DefaultValue("A"), Required] string DriversLicenseLevel,
